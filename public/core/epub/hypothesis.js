  ...
  function start() {
    ...
    var url = params && params.get("iDbook") && decodeURIComponent(params.get("iDbook"));

    var urlActual = window.location.href;
    var parts = urlActual.split("?");
    var path = parts[0];
    var pathParts = path.split("/");
    var lastSlug = pathParts[pathParts.length - 2];

    var defaultUrl = window.location.protocol + "/public/" + lastSlug +".epub";
